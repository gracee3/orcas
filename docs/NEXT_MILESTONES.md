...
- The daemon socket transport is live. The request surface now includes Codex thread lifecycle wiring, workspace actions, daemon-state-first lifecycle operations, and managed-project bootstrap/spawn/attach/director/inspect; the next step is richer drill-down/selection ergonomics and cleanup of the remaining compatibility surfaces.
