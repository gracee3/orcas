...
Codex-thread assignment metadata is also Orcas-native and is kept separate from Codex thread runtime/history.
...
- [Codex Thread Supervision v1](docs/codex-thread-supervision-v1.md)
