...
Prefer the smallest useful next step, clear handoff language, and explicit ownership boundaries.
Do not drift into broad implementation unless the current turn is explicitly an execution turn.
