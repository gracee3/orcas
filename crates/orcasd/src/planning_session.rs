...
use orcas_core::planning::{self, PlanRevisionOp, PlanRevisionProposal, PlanRevisionProposalId};
...
pub fn planning_session_thread_prompt(
    ...
    prompt
        .push_str("You are the Codex planning delegate for a supervisor-owned planning session.\n");
    ...
    prompt.push_str("- RequestResearch: ask Orcas to run one bounded research assignment.\n");
...
mod tests {
    ...
    use orcas_core::planning::{PlanGoal, PlanGoalId, PlanId, PlanStatus, WorkstreamPlan};
