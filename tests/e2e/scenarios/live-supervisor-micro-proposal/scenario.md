...
Verify that TT can take one real live worker report, generate a bounded supervisor proposal from that persisted report, and create the next assignment through operator approval.
