...
e2e_prepare_live_tt_environment "lwl" 5800 16384
...
branch_name="tt/$NAME/$branch_suffix"
...
grep -q 'Hello, TT!' "$worktree_path/main.c"
...
e2e_tt workunit thread get --tracked-thread "$tracked_thread_id" >"$tracked_thread_bound_stdout"
...
e2e_tt supervisor work reports get --report "$prepare_report_id" >"$prepare_report_get_stdout"
...
e2e_tt supervisor work assignments get --assignment "$prepare_assignment_id" >"$prepare_assignment_get_stdout"
...
e2e_tt workunit thread get --tracked-thread "$tracked_thread_id" >"$prepare_thread_get_stdout"
...
e2e_tt supervisor work reports get --report "$merge_prep_report_id" >"$merge_prep_report_get_stdout"
e2e_tt supervisor work assignments get --assignment "$merge_prep_assignment_id" >"$merge_prep_assignment_get_stdout"
e2e_tt workunit thread get --tracked-thread "$tracked_thread_id" >"$merge_prep_thread_get_stdout"
...
e2e_tt workunit thread get --tracked-thread "$tracked_thread_id" >"$authorize_thread_get_stdout"
...
e2e_tt workunit thread get --tracked-thread "$tracked_thread_id" >"$landing_execution_thread_get_stdout"
...
e2e_tt workunit thread get --tracked-thread "$tracked_thread_id" >"$prune_thread_get_stdout"
